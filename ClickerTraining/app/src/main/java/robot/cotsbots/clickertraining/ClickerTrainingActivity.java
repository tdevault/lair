package robot.cotsbots.clickertraining;
...
public class ClickerTrainingActivity extends Activity implements CameraBridgeViewBase.CvCameraViewListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clicker_training);
    ...
    public void startRobot(View view){
        ...
        myRobot = new Robot(robotAddress, SteeringType.TRACKED, myRobotData, true, this);

        client = new robotClient( SteeringType.TRACKED, myRobot);
        client.startRemote();
